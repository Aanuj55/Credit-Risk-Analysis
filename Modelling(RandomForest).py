# -*- coding: utf-8 -*-
"""
Created on Tue Jun  2 09:00:54 2020
...
tarEncoder = ce.TargetEncoder(smoothing=200)
...
#file = open('RandomForestModel_13.csv','a')
model = RandomForestClassifier(n_estimators=25,criterion='gini',random_state=9,\
                               max_samples=0.7,max_depth=14,min_samples_split=225,\
                               min_samples_leaf=25,min_impurity_decrease=0.000001,max_leaf_nodes=1200)
...
#                                                             params['max_leaf_nodes'],params['min_impurity_decrease'],\
#                                                             test_auc,train_auc))
